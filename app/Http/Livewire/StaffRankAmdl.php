...
use App\Models\Rank;
class StaffRankAmdl extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.staff-amdl',['users' => $this->search === null ?
            Seeker::where('rank_id',$this->department->id)->orderBy('first_name')->paginate($this->perPage):
            Seeker::where('rank_id',$this->department->id)->where('first_name', 'like', '%' . $this->search . '%')

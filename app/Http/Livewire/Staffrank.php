...
class Staffrank extends Component
{
...
//dd($this->department);
        return view('livewire.staff-msnc',['users' => $this->search === null ?
            TblUser::where('rank_id',  $this->department->id )->orderBy('lastName')->paginate($this->perPage):
            TblUser::where('rank_id',  $this->department->id )->

        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('storeMsncHod') }}"  role="form" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="">
                                <div class="row">
                                  ...
                                  <input type="hidden" name="department_id" value="{{$user->station->deptID}}">
                                  <input type="hidden" name="station_id" value="{{$user->station->stationID}}">
                                  <input type="hidden" name="sub_department_id" value="{{$user->subdepartment->id}}">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="">Full Name</label>
                                            <input type="text" class="form-control" value="{{$user->user->firstName .' '.$user->user->lastName}}" readonly name="name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$user->station->deptName}}" disabled name="department">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">

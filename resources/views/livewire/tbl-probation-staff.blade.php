<div>
    ...
    @endif
    @if($createMode)
        @include('livewire.createMsncProbation')
                        ...
                        @foreach($staffs as $key => $staff)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-info" href="{{route('msncMonthlyGoals.index',['id1' => encrypt($staff->station_id), 'id2' => encrypt($staff->user_id)])}}"><i class="fa fa-fw fa-edit"></i> Goals</a>

        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body box-profile">
                    ...
                    <h3 class="profile-username text-center">{{$member->title}} {{$member->firstName}} {{$member->lastName}} {{$member->otherName}}</h3>
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                            <span>Email</span> <b class="float-right">{{$member->emailAddress}}</b>
                        </li>
                        <li class="list-group-item">
                            <span>Alt Email</span> <b class="float-right">{{$member->altEmail}}</b>
                        </li>
                        <li class="list-group-item">
                    ...
                    <button class="btn bg-maroon btn-block"><b>RANK: {{ucwords($member->tblRank->rank ?? '')}}</b> </button>
